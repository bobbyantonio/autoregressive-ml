...
srun python /home/a/antonio/repos/autoregressive-ml/automl/fetch_era5.py --year 2016 --output-dir /network/group/aopp/predict/HMC005_ANTONIO_EERIE/era5 --plevels --days 1 15 --months 1 2 7 8;
